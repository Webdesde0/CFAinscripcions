...
class CFA_Cursos {
    ...
    public static function register_post_type() {
        ...
        $args = array(
            ...
            'show_ui'             => true,
            'show_in_menu'        => current_user_can('cfa_gestionar_calendaris') ? 'cfa-inscripcions' : false,
            'query_var'           => false,
            'capability_type'     => 'post',
            'capabilities'        => array(
                'edit_post'          => 'cfa_gestionar_calendaris',
                'read_post'          => 'cfa_gestionar_calendaris',
                'delete_post'        => 'cfa_gestionar_calendaris',
                'edit_posts'         => 'cfa_gestionar_calendaris',
                'edit_others_posts'  => 'cfa_gestionar_calendaris',
                'publish_posts'      => 'cfa_gestionar_calendaris',
                'read_private_posts' => 'cfa_gestionar_calendaris',
            ),
            'has_archive'         => false,
            'hierarchical'        => false,
            'menu_position'       => null,
